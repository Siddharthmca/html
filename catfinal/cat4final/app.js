...
addBtn.onclick = function () {
    ...
    // const s_class = classInput.value;
    // const s_event = eventInput.value;
    // const s_team = teamInput.value;
    nameInput.value = "";
    // classInput.value = "";
    // eventInput.value = "";
    // teamInput.value = "";
...
function loadHTMLTable(data) {
    ...
    data.forEach(function ({id, name, s_class, s_event, s_team}) {
        tableHtml += "<tr>";
        tableHtml += `<td>${id}</td>`;
        tableHtml += `<td>${name}</td>`;
        tableHtml += `<td>${s_class}</td>`;
        tableHtml += `<td>${s_event}</td>`;
        tableHtml += `<td>${s_team}</td>`;
